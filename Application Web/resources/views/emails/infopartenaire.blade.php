...
<body>
    ...
    <div class="jumbotron">
        <div class="container">
          ...
          <p>
            Bonjour/bonsoir cher Client, <br> Suite a votre demande de reservation le partenaire a accepté votre demande , alors voici les informations pour vous mettre on contact avec lui.. Bonne Location</p>
         </div>
      </div>
    <div class="card m-5 ">
        <div class="card-header text-center">
          <h2>Information de Partenaire </h2>
        </div>
